...
class JobstreetsearchSpider(scrapy.Spider):
    ...
    start_urls           = ['https://www.jobstreet.co.id/en/job-search/job-vacancy/1401/?src=16&srcr=16&ojs=1']
    
    def parse(self, response):    
        page_number = response.meta.get('page_number') or 1401   
        ...
        if int(page_number) == 1552: 
            page_number = 1552
        elif int(page_number) >= 1401: 
    ...
    def parse_page(self, response):
        ...
        # -------------------------------------------------------------------------------------------- INSERT INTO WEB
            sql = "INSERT INTO `web_jobstreet`(`website`, `url`, `date_time`, `company`, `domain_of_the_jobs`, `job_title`, `position`, `experience`, `location`, `salary1`, `salary2`, `qualification_level`, `type_of_job`, `page`, `group_page`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
