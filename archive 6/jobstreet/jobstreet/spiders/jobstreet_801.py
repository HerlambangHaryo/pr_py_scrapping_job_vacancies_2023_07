...
class JobstreetsearchSpider(scrapy.Spider):
    ...
    start_urls           = ['https://www.jobstreet.co.id/en/job-search/job-vacancy/801/?src=16&srcr=16&ojs=1']
    
    def parse(self, response):    
        page_number = response.meta.get('page_number') or 801   
