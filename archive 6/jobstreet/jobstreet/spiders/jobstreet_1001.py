...
class JobstreetsearchSpider(scrapy.Spider):
    ...
    start_urls           = ['https://www.jobstreet.co.id/en/job-search/job-vacancy/1001/?src=16&srcr=16&ojs=1']
    
    def parse(self, response):    
        page_number = response.meta.get('page_number') or 1001   
        ...
        if int(page_number) == 1200: 
            page_number = 1200
        elif int(page_number) >= 1001: 
