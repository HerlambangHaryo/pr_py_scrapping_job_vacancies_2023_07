...
class GokarirsearchSpider(scrapy.Spider):
    ...
    start_urls           = ['https://gokarir.com/jobs?p=1']
    ...
    def parse(self, response):    
        ...
        for row in data_scrap:              
            # -------------------------------------------------------------------------------------------- URL
            url          = row.xpath('div[@class="desktop-listing-content"]/div[@class="noMP col-md-7 col-sm-7 col-xs-7"][1]/a[2]/@href').extract_first()   
            ...
            sql = "INSERT INTO `gokarir_new`(`website`, `url`, `date_time`, `company`, `domain_of_the_jobs`, `jobs`, `position`, `experience`, `location`, `salary`, `qualification_level`, `page`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
